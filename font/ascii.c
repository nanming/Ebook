...
static T_FontOpr AsciiFontOpr = {
	        .name           = "ascii",
		.FontInit       = AsciiFontInit,
		.GetCodeBitMap  = AsciiGetFontBitMap,
};
...
static int AsciiGetFontBitMap(unsigned int dwCode, Pt_FontBitMap ptFontBitMap)
{
	...
	if (dwcode > (unsigned int dwcode)0x80)
	{
		return -1;
	}	
	...
	ptFontBitMap->iNextOriginX	= iPenY;

	return 0;

}

int AscFontInit(void)
{
	return RegisterFontOpr(&AsciiFontOpr);
}
